...
export interface ProdbrewComponentsTechSection extends Schema.Component {
  collectionName: 'components_prodbrew_components_tech_sections';
  info: {
    displayName: 'Tech_Section';
  };
  attributes: {
    title: Attribute.String;
    techstacks: Attribute.Component<'prodbrew-components.tech-content', true>;
  };
}

export interface ProdbrewComponentsTechContent extends Schema.Component {
  collectionName: 'components_prodbrew_components_tech_contents';
  info: {
    displayName: 'Tech_content';
  };
  attributes: {
    name: Attribute.String;
    icon_url: Attribute.String;
    color: Attribute.String;
    icon_image: Attribute.Media<'images' | 'files' | 'videos' | 'audios', true>;
  };
}

export interface ProdbrewComponentsServicesSection extends Schema.Component {
  collectionName: 'components_prodbrew_components_services_sections';
  info: {
  ...
  attributes: {
    ...
    rows: Attribute.Component<'prodbrew-components.service-card', true>;
  };
}

export interface ProdbrewComponentsServiceCard extends Schema.Component {
  collectionName: 'components_prodbrew_components_service_cards';
  info: {
...
export interface ProdbrewComponentsHeader extends Schema.Component {
  collectionName: 'components_prodbrew_components_headers';
  info: {
    displayName: 'Header';
    description: '';
  };
  attributes: {
    ...
    options: Attribute.Component<'prodbrew-components.header-list', true>;
  };
}

export interface ProdbrewComponentsHeaderList extends Schema.Component {
  collectionName: 'components_prodbrew_components_header_lists';
  info: {
    displayName: 'Header_list';
  };
  attributes: {
    headname: Attribute.String;
    url: Attribute.String;
  };
}

export interface ProdbrewComponentsFooter extends Schema.Component {
  collectionName: 'components_prodbrew_components_footers';
  info: {
    displayName: 'Footer';
    description: '';
  };
  attributes: {
    ...
    social_media_icons: Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    location_address: Attribute.Text;
    footer_content: Attribute.Component<
      'prodbrew-components.footer-content',
      true
    >;
  };
}

export interface ProdbrewComponentsFooterContent extends Schema.Component {
  collectionName: 'components_prodbrew_components_footer_contents';
  info: {
...
export interface ProdbrewComponentsCompanyContent extends Schema.Component {
  collectionName: 'components_prodbrew_components_company_contents';
  info: {
    displayName: 'company_content';
  };
  attributes: {
    name: Attribute.String;
    url: Attribute.String;
...
export interface ProdbrewComponentsCompanies extends Schema.Component {
  collectionName: 'components_prodbrew_components_companies';
  info: {
  ...
  attributes: {
    title: Attribute.String;
    description: Attribute.Text;
    list: Attribute.Component<'prodbrew-components.company-content', true>;
  };
}

export interface ProdbrewComponentsBanner extends Schema.Component {
  collectionName: 'components_prodbrew_components_banners';
  info: {
    displayName: 'Banner';
  };
  attributes: {
    title: Attribute.String;
    description: Attribute.Text;
    interactive_image: Attribute.Media<'images', true>;
  };
}
...
declare module '@strapi/types' {
  export module Shared {
    export interface Components {
      'prodbrew-components.tech-section': ProdbrewComponentsTechSection;
      'prodbrew-components.tech-content': ProdbrewComponentsTechContent;
      'prodbrew-components.services-section': ProdbrewComponentsServicesSection;
      'prodbrew-components.service-card': ProdbrewComponentsServiceCard;
      'prodbrew-components.header': ProdbrewComponentsHeader;
      'prodbrew-components.header-list': ProdbrewComponentsHeaderList;
      'prodbrew-components.footer': ProdbrewComponentsFooter;
      'prodbrew-components.footer-content': ProdbrewComponentsFooterContent;
      'prodbrew-components.company-content': ProdbrewComponentsCompanyContent;
      'prodbrew-components.companies': ProdbrewComponentsCompanies;
      'prodbrew-components.banner': ProdbrewComponentsBanner;
