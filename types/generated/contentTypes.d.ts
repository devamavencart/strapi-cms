...
export interface ApiProdBrewHomepageProdBrewHomepage
  extends Schema.CollectionType {
  collectionName: 'prod_brew_homepages';
  info: {
    singularName: 'prod-brew-homepage';
    pluralName: 'prod-brew-homepages';
    displayName: 'Prod-Brew-Homepage';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    Banner: Attribute.Component<'prodbrew-components.banner'>;
    header: Attribute.Component<'prodbrew-components.header'>;
    CompanyList: Attribute.Component<'prodbrew-components.companies', true>;
    Services: Attribute.Component<'prodbrew-components.services-section', true>;
    Technologies: Attribute.Component<'prodbrew-components.tech-section'>;
    footer: Attribute.Component<'prodbrew-components.footer'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::prod-brew-homepage.prod-brew-homepage',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::prod-brew-homepage.prod-brew-homepage': ApiProdBrewHomepageProdBrewHomepage;
    }
  }
}
